package com.ekosp.indoweb.epesantren.uploadpdfaditya;
...
public class UploadActivity extends AppCompatActivity {
    ...
    public static final String PDF_UPLOAD_HTTP_URL = "https://examplerestapi.000webhostapp.com/file_upload.php";
